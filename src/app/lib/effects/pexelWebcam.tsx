...
type WebcamPixelGridProps = {
  ...
  /** Background color shown when webcam permission is denied */
  deniedBackgroundColor?: string;
...
export function WebcamPixelGrid({
  ...
  // Resolve which background to use
  const activeBackgroundColor = error ? deniedBackgroundColor : backgroundColor;
  ...
  return (
    <div className={cn("relative h-full w-full", className)}>
      ...
      {error && showErrorPopup && (
        <div className="animate-in fade-in slide-in-from-top-2 bg-red fixed top-4 right-4 z-50 duration-300">
          <div className="relative flex max-w-sm items-start gap-3 rounded-lg border border-white/10 bg-red/80 p-4 shadow-2xl backdrop-blur-xl">
            {/* Close button */}
            <button
...
export function WebcamPixelGridDemo() {
  return (
    <div className="relative h-screen w-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-red/40 via-transparent to-red/60 pointer-events-none" />

      {/* Hero content */}
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4">
        <div className="max-w-4xl text-center">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 text-red-500 px-4 py-1.5 text-sm text-white/70 backdrop-blur-sm">
            Introducing AARGEEBEE &rarr;
          </div>

          {/* Title */}
          <div>
            <h1 className="mb-6 text-xl font-bold tracking-tight text-white sm:text-6xl md:text-8xl">
              Welcome to your pexel perfect world.
            </h1>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <button className="inline-flex h-12 items-center justify-center gap-2 rounded-full border border-white/20 bg-red/50 px-8 text-base font-medium text-white backdrop-blur-sm transition-all hover:bg-white/10 hover:border-red/30">
              About Us
            </button>
          </div>
        </div>
